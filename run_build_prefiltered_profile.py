"""Compatibility wrapper for the Rust prefiltered profile builder."""
...
def build_delegated_command(argv: list[str] | None = None) -> list[str]:
    return [*_rust_binary_command(), "build-prefilter-profile-runtime", *(argv if argv is not None else sys.argv[1:])]
