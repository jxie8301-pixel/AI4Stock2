"""Compatibility wrapper for the Rust full-space single-factor preset."""
...
def build_delegated_command(argv: list[str] | None = None) -> list[str]:
    return [*_rust_binary_command(), "full-space-single-factor", *(argv if argv is not None else sys.argv[1:])]
