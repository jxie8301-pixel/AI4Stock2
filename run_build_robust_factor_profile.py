"""Compatibility wrapper for the Rust robust profile builder."""
...
def build_delegated_command(argv: list[str] | None = None) -> list[str]:
    return [*_rust_binary_command(), "build-robust-profile-runtime", *(argv if argv is not None else sys.argv[1:])]
