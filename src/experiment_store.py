...
def finalize_run_store(
    ...
    *,
    ...
    summary_row = {
        ...
        "max_industry_weight": cfg.get("strategy", {}).get("max_industry_weight", ""),
        "desticky_signal_threshold": cfg.get("strategy", {}).get("desticky_signal_threshold", ""),
        "desticky_n_drop": cfg.get("strategy", {}).get("desticky_n_drop", ""),
